...
mkdir $DATA_DIR
$MULTICHAIN_UTIL create vote_chain -datadir=$DATA_DIR -default-network-port=8000 -anyone-can-connect=true -anyone-can-send=true -anyone-can-receive=true -root-stream-name=voting_stream -root-stream-open=true -anyone-can-issue=true -anyone-can-mine=true -anyone-can-activate=true -anyone-can-admin=true
